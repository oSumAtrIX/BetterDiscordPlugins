        ...
        textArea.addEventListener("keyup", function(event) {
            ...
            if (event.keyCode === 13) {
                if (content.substring(0, 3).includes("yt ")) {
                    $.getJSON('https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&q=' + content.substring(3, content.length) + '&type=video&key=AIzaSyB8yFpnD-iQqwgjBvQHgmw0SJn-JXBF7u0', function(data) {
